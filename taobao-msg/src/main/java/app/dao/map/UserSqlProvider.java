...
import app.dao.domain.UserExample;
import app.dao.domain.UserExample.Criteria;
import app.dao.domain.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getRegistTime() != null) {
            SET("regist_time = #{record.registTime,jdbcType=TIMESTAMP}");
        }
